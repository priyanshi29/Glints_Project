...
def populate_data(**context):
    psql_conn1 = "host=glints_project-database-1 port=5432 dbname=glints_db user=airflow password=airflow"            
    psql_conn2 = "host=glints_project-database1-1 port=5432 dbname=glints_db user=airflow password=airflow"   
